...
public:
    ...
    bool                    mIsOnBoard;
    bool                    mHighlighted;
    int32_t                 mRLSquashDamage;
    int32_t                 mRLSquashHits;
...
public:
    ...
    static Zombie*          FindSquashTargetAt(Board* theBoard, LawnApp* theApp, int theRow, int theX, int theWidth, ZombieID theTargetZombieID = ZombieID::ZOMBIEID_NULL);
